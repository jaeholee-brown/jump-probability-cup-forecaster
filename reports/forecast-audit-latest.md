...
Generated: `2026-06-18T18:37:21.929296+00:00`
...
- Direct/specific evidence coverage: 90/90 settled forecasts.
- ESPN retrospective resolver coverage: 90/90 settled forecasts; 1 disagree with platform outcomes.
...
| settled_records_with_direct_or_adjacent_evidence | 90 |
| settled_records_with_espn_resolver | 90 |
| espn_resolver_mismatches | 1 |
...
| GHA vs PAN | 10 | 10 | 4 | 2 | 2 | Ghana was only a slight favorite around +127 to +130, Panama around +220 to +245, draw around +220 to +245; Under 2.5 was materially favored. | Ghana beat Panama 1-0 in a low-event match. |
...
| direct_retrospective_stat | 73 | 0.2134 | 0.4723 | 0.3699 | 0.1025 | 0.446 |

## External Evidence Gaps By Family

_No rows._

## ESPN Resolver Mismatches

| match_name | question | family | probability_int | outcome | espn_resolved_outcome | espn_evidence_basis | espn_source_url |
| --- | --- | --- | --- | --- | --- | --- | --- |
| GHA vs PAN | Will Antoine Semenyo have at least 1 shot on target? | shots-on-target | 64 | 1 | 0 | ['Antoine Semenyo ESPN SOT/goal events in full match: 0.'] | https://www.espn.com/soccer/match/_/gameId/760434 |
...
| POR vs COD | In the second half, will Portugal have more shots on target than DR Congo? | shots-on-target | 68 | 0 | 0.4624 | pre-evidence-qa | direct_retrospective_stat | 0 |  |
| GHA vs PAN | Will Ghana have 3 or more shots on target? | shots-on-target | 67 | 0 | 0.4489 | pre-evidence-qa | direct_retrospective_stat | 5 | 6.0 |
| UZB vs COL | Will Uzbekistan score at least 1 goal? | goals | 35 | 1 | 0.4225 | pre-evidence-qa | direct_retrospective_stat | 5 | 3.0 |
| IRQ vs NOR | Will there be 4 or more total shots on target in the second half? | shots-on-target | 62 | 0 | 0.3844 | pre-evidence-qa | direct_retrospective_stat | 4 | 13.0 |
| ENG vs CRO | Will a penalty kick be awarded OR a red card be shown? | penalty-red | 38 | 1 | 0.3844 | pre-evidence-qa | direct_retrospective_stat | 5 | 8.0 |
| IRQ vs NOR | Will Iraq score at least 1 goal? | goals | 39 | 1 | 0.3721 | pre-evidence-qa | direct_retrospective_stat | 4 | 5.0 |
| FRA vs SEN | Will Senegal receive at least 1 card in the second half? | cards | 59 | 0 | 0.3481 | platform-only | direct_retrospective_stat | 0 |  |
| ARG vs ALG | Will Algeria commit more fouls than Argentina? | fouls | 58 | 0 | 0.3364 | pre-evidence-qa | direct_retrospective_stat | 4 | 1.0 |
| FRA vs SEN | Will both teams score AND the match have 3 or more total goals? | goals | 42 | 1 | 0.3364 | platform-only | direct_retrospective_stat | 0 |  |
| FRA vs SEN | Will France score in the first half? | other | 58 | 0 | 0.3364 | platform-only | direct_retrospective_stat | 0 |  |
| UZB vs COL | Will Colombia have more shots on target than Uzbekistan in the second half? | shots-on-target | 58 | 0 | 0.3364 | pre-evidence-qa | direct_retrospective_stat | 5 | 8.0 |
| CZE vs RSA | Will South Africa score in the second half? | other | 43 | 1 | 0.3249 | post-evidence-qa | direct_retrospective_stat | 5 | 4.0 |
| CZE vs RSA | Will a penalty kick be awarded OR a red card be shown in the match? | penalty-red | 43 | 1 | 0.3249 | post-evidence-qa | direct_retrospective_stat | 5 | 5.0 |

## Best Settled Markets

| match_name | question | family | probability_int | outcome | brier | stage | external_evidence_level | component_count | component_spread_points |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| POR vs COD | Will Gonçalo Ramos score a goal (excluding own goals)? | player-goal | 17 | 0 | 0.0289 | pre-evidence-qa | direct_retrospective_stat | 5 | 7.0 |
| IRQ vs NOR | Will Mohanad Ali score or assist a goal (excluding own goals)? | player-goal-assist | 18 | 0 | 0.0324 | pre-evidence-qa | direct_retrospective_stat | 4 | 13.0 |
| AUT vs JOR | Will Jordan have more shots on target than Austria in the second half? | shots-on-target | 22 | 0 | 0.0484 | pre-evidence-qa | direct_retrospective_stat | 4 | 6.0 |
| CZE vs RSA | Will Oswin Appollis score or assist a goal (excluding own goals)? | player-goal-assist | 24 | 0 | 0.0576 | post-evidence-qa | direct_retrospective_stat | 0 |  |
| IRQ vs NOR | Will Iraq have more shots on target than Norway in the second half? | shots-on-target | 24 | 0 | 0.0576 | pre-evidence-qa | direct_retrospective_stat | 3 | 5.0 |
...
| AUT vs JOR | Will Jordan finish with more corner kicks than Austria? | corners | 26 | 0 | 0.0676 | pre-evidence-qa | direct_retrospective_stat | 0 |  |
| FRA vs SEN | Will Sadio Mané score a goal (excluding own goals)? | player-goal | 26 | 0 | 0.0676 | platform-only | direct_retrospective_stat | 0 |  |
| POR vs COD | Will DR Congo commit more fouls than Portugal? | fouls | 73 | 1 | 0.0729 | pre-evidence-qa | direct_retrospective_stat | 5 | 8.0 |
| ARG vs ALG | Will Argentina score the first goal of the game and Algeria score in the second half? | goals | 28 | 0 | 0.0784 | pre-evidence-qa | direct_retrospective_stat | 4 | 16.0 |
| ARG vs ALG | Will Argentina win the match? | result | 71 | 1 | 0.0841 | pre-evidence-qa | direct_market_line | 0 |  |
| ENG vs CRO | At halftime, will Croatia have more corner kicks than England? | corners | 30 | 0 | 0.09 | pre-evidence-qa | direct_retrospective_stat | 0 |  |
...
| GHA vs PAN | Will Panama score the first goal of the second half? | goals | 30 | 0 | 0.09 | pre-evidence-qa | direct_retrospective_stat | 5 | 8.0 |
