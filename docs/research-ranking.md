...
| 3 | Multi-model or multi-prompt aggregation in log-odds space | High | ForecastBench's top-three-model aggregate compared aggregation methods; geometric mean/log-odds methods scored 0.194 vs 0.197 for median/trimmed mean. Silicon-crowd Study 1 used 12 LLMs on 31 live Metaculus questions and was statistically indistinguishable from 925-human crowd. | Four independent prompt variants are combined by weighted log-odds mean, with configurable extremization. |
