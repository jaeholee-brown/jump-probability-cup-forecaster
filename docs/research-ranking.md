...
|---:|---|---|---|---|
| 1 | Fresh retrieval plus relevance filtering and summarization | Very high | Halawi et al. built a retrieval-augmented forecasting system over 914 test questions from a 5,516-question curated set. Best raw GPT-4 baseline Brier was 0.208; full system reached 0.179. Removing both retrieval and fine-tuning fell to 0.206. | OpenAI web-search evidence pass per match; optional odds data; compact evidence passed into the forecaster. |
